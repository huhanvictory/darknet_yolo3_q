...
#define SECRET_NUM -1234
    ...
    //float xilinx_quantizer(float input, int divider);
    ...
    struct layer
    {
        int bpos_bw, bpos;
        int wpos_bw, wpos;
        int ipos1_bw, ipos1; // for operations with one input (such as Conv), these are actually ipos_bw, and ipos. For shortcuts, this is the near operand
        int ipos2_bw, ipos2;
        int opos_bw, opos;
